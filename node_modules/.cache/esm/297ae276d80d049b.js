let RESPONSES,EMAIL_MIN_LENGTH,EMAIL_MAX_LENGTH,USERNAME_MIN_LENGTH,USERNAME_MAX_LENGTH,PASSWORD_MIN_LENGTH;_d80‍.x([["verifyAuthToken",()=>verifyAuthToken],["genVerificationCode",()=>genVerificationCode],["genRandomToken",()=>genRandomToken],["executeQuery",()=>executeQuery],["checkEmailAddress",()=>checkEmailAddress],["checkUsername",()=>checkUsername],["checkPassword",()=>checkPassword],["jwtVerifyUser",()=>jwtVerifyUser]]);_d80‍.w("./helperConstants",[["RESPONSES",["RESPONSES"],function(v){RESPONSES=v}]]);_d80‍.w("./lengthConstants",[["EMAIL_MIN_LENGTH",["EMAIL_MIN_LENGTH"],function(v){EMAIL_MIN_LENGTH=v}],["EMAIL_MAX_LENGTH",["EMAIL_MAX_LENGTH"],function(v){EMAIL_MAX_LENGTH=v}],["USERNAME_MIN_LENGTH",["USERNAME_MIN_LENGTH"],function(v){USERNAME_MIN_LENGTH=v}],["USERNAME_MAX_LENGTH",["USERNAME_MAX_LENGTH"],function(v){USERNAME_MAX_LENGTH=v}],["PASSWORD_MIN_LENGTH",["PASSWORD_MIN_LENGTH"],function(v){PASSWORD_MIN_LENGTH=v}]]);
...
// var mysql = require("mysql");
	...
	return Math.floor((Math.random() * 100000))
       ...
       function genRandomToken(seedText, length) {
	let chars =
...
function emailUnavailable() {
	...
	return new Promise((resolve, reject) => {
		conn.query(sql, (error, results, fields) => {
			if (error) {
				_d80‍.g.console.log("db error at executeQuery: ", error)
 ...
 */
    ...
    if(
		...
		username.length > USERNAME_MAX_LENGTH
		 ...
		 _d80‍.g.console.log(new Error().stack.split(/\r\n|\r|\n/g)[1].trim())
	...
	try{
		if(arguments.length == 1){
			...
			if(mysqlQueryResponse.length === 0){
				...
				_d80‍.g.console.log('mysql query response object: ', mysqlQueryResponse[0])
				resolve(RESPONSES.USERNAME_AVAILABLE)
			}else{
				 _d80‍.g.console.log(new Error().stack.split(/\r\n|\r|\n/g)[1].trim())
				reject(RESPONSES.USERNAME_UNAVAILABLE)
...
// }
	 ...
	 return new Promise((resolve, reject) => {
       ...
       async function jwtVerifyUser(authToken, publicKey){
	return new Promise((resolve, reject) =>{
