let conn,RESPONSES,verifyAuthToken,genRandomToken,checkEmailAddress,checkUsername,checkPassword,executeQuery;_a8b‍.w("../functions/db",[["conn",["conn"],function(v){conn=v}]]);_a8b‍.w("../functions/helperConstants",[["RESPONSES",["RESPONSES"],function(v){RESPONSES=v}]]);_a8b‍.w("../functions/helpers",[["verifyAuthToken",["verifyAuthToken"],function(v){verifyAuthToken=v}],["genRandomToken",["genRandomToken"],function(v){genRandomToken=v}],["checkEmailAddress",["checkEmailAddress"],function(v){checkEmailAddress=v}],["checkUsername",["checkUsername"],function(v){checkUsername=v}],["checkPassword",["checkPassword"],function(v){checkPassword=v}],["executeQuery",["executeQuery"],function(v){executeQuery=v}]]);var express = require("express");
...
auth.post("/login", async function(req, res){
	...
	try {
		...
		_a8b‍.g.console.log(req.body)

		_a8b‍.g.console.log(primaryFieldType)
		...
		_a8b‍.g.console.log(users_sql)
		let usersSqlResult =  await executeQuery(users_sql)
		_a8b‍.g.console.log("usersSqlResult : ", usersSqlResult)
		...
		_a8b‍.g.console.log("authSqlResult : ", authSqlResult)
		...
		if(sha256.hmac(user_auth.salt, password) === user_auth.password_hash){
			//initialize userAuthPayload response
				...
				//--------LOG-------//
				_a8b‍.g.console.log(authToken)
				_a8b‍.g.console.log(userAuthPayload)
		...
		_a8b‍.g.console.log("login error: ", e)
		return res.json(e);
	}
})
...
auth.post("/signup", async function(req, res) {
	...
	try {
		...
		//--------LOG-------//
		_a8b‍.g.console.log(checkEmailAddress_RESPONSE);
		_a8b‍.g.console.log(checkPassword_RESPONSE);
